...
export function MorePage({ themeOverride, setThemeOverride }: MorePageProps) {
    ...
    return (
        <div className="more-page">
            ...
            {/* ─── Affiliate / Referral Locking System ─── */}
            {!user?.phone_verified ? (
                <Section header="Affiliate Program">
                    <div style={{ padding: '24px 16px', textAlign: 'center', background: 'var(--tg-theme-bg-color)' }}>
                        <div style={{ fontSize: '16px', fontWeight: 'bold', color: 'var(--tg-theme-text-color)', marginBottom: '8px' }}>
                            Affiliate Program
                        </div>
                        <div style={{ fontSize: '13px', color: 'var(--tg-theme-hint-color)', marginBottom: '20px', lineHeight: '1.4' }}>
                            Verify your phone number to access the Affiliate Program
                        </div>
                        <PhoneVerification />
                    </div>
                </Section>
                            ...
                            {tgColors.map((color, idx) => (
                                <div 
                                    ...
                                    onClick={() => {
                                        ...
                                        showToast('success', `${color.paramName} copied!`);
                                    }}
                                    style={{
                                        display: 'flex',
                                        alignItems: 'center',
                                ...
                                >
                                    ...
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '2px' }}>
                                            <span style={{ fontSize: '13px', fontWeight: 'bold', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                                {color.name}
                                            </span>
                                            <span style={{ fontSize: '9px', fontFamily: 'monospace', color: 'var(--tg-theme-hint-color, #8b8baf)', opacity: 0.8 }}>
                                                {color.paramName}
                                            </span>
                                        </div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <span style={{ fontSize: '11px', color: 'var(--tg-theme-hint-color, #8b8baf)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '60%' }}>
                                                {color.desc}
                                            </span>
                                            <span style={{ fontSize: '9px', fontFamily: 'monospace', color: 'var(--tg-theme-button-color, #7c5cfc)', fontWeight: 600 }}>
                                                {color.varName}
                                            </span>
                                        </div>
                                    </div>
